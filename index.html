			...
			<div class="aside-dropdown">
				...
				<div class="aside-dropdown__item">
					...
					<ul class="aside-menu">
						...
						<li class="aside-menu__item"><a class="aside-menu__link" href="https://docs.google.com/forms/d/e/1FAIpQLSfAs2Y4c65Jtp-AyNVQoEA9rmy4X7LD0O4SiKRqNnZqSgOVoQ/viewform">Be a Volunteer</a></li>

					-->
						<li class="aside-menu__item"><a class="aside-menu__link" href="team.php">Our Team</a></li>
						<li class="aside-menu__item"><a class="aside-menu__link" href="insert_team.php">Be a Volunteer</a></li>
...
<a target="_blank" href="nextpage.php?id=<?php echo $res_event['e_id']; ?>"style="color: yellow""font-weight:bold"><?php echo "<tr><td>".($res_event['e_name'])."<br></td></tr>"; ?></a>
<br>
<?php
}
...
?>
									...
									<li class="main-menu__item"><a class="main-menu__link" href="event.php" target="_blank"><span>Events</span></a></li>
									<li class="main-menu__item"><a class="main-menu__link" href="insert_contact.php" target="_blank"><span>Contacts</span></a></li>

									<!--<li class="main-menu__item"><a class="main-menu__link" href="https://docs.google.com/forms/d/e/1FAIpQLSe-bzGMBq0P4Y8Gm4A34Ciw9LEGWniPEZ1gQDCiWXkPjaXjMA/viewform"><span>Contacts</span></a></li>-->
								</ul>
							</nav>
							<!-- main menu end-->
						</div>
...
<?php
$qry="select * from karma_ini where status=1;";
$qes=$conn->query($qry);
...
?>
							...
							<div class="projects-masonry__item projects-masonry__item--primary projects-masonry__item--height-2">
								<div class="projects-masonry__img">
									<?php
										...
										$str="<a target='_blank'><img class='img--bg' src='img/".$res["e_img"]."' alt='img'></a>";
										echo $str;
									?>
									<div class="projects-masonry__inner"><span class="projects-masonry__badge" style="background: #F36F8F;">
										<?php echo $res["e_name"]; ?></span>
										<h3 class="projects-masonry__title"><a href="<?php echo $res["link"]; ?>" target="_blank"><?php echo $res["e_heading"];?></a></h3>
							...
							<div class="col-md-6 col-lg-4">
								<div class="event-item">
									<!--<div class="event-item__img">-->
										...
										<?php
										    $ev_img="";
    										$qes_event = "SELECT * FROM events where ev_id='1'";
    										$qry_event=$conn->query($qes_event);
    ...
    ?>
        ...
        <a target="_blank" >
			...
			<h3 class="event-item__title"> <?php echo $heading; ?></h3>
           	<p> <?php echo $place; ?></p>
            <p><?php echo $date; ?></p>
			</div>
							...
							<div class="col-md-6 col-lg-4">
								<div class="event-item">
									<!--<div class="event-item__img">-->
										<?php
										    $ev_img="";
    										$qes_event = "SELECT * FROM events where ev_id='2'";
    										$qry_event=$conn->query($qes_event);
							...
							<div class="col-md-6 col-lg-4">
								<div class="event-item">
									<!--<div class="event-item__img">-->
										<?php
										    $ev_img="";
    										$qes_event = "SELECT * FROM events where ev_id='3'";
    										$qry_event=$conn->query($qes_event);
    ...
    ?></div>
						...
						<div class="row">
							<center><div class="col-12 text-center"><a class="button button--primary" href="event.php" target="_blank">View all events</a></div></center>
						</div>
					</div>
				</section>
				<!-- events end-->
				...
				<section class="section donors donors--style-2 no-padding-top no-padding-bottom">
					<div class="container">
						<div class="row margin-bottom">
							<div class="col-12">
								<div class="heading heading--primary heading--center"><span class="heading__pre-title"><h2 lass="heading__title no-margin-bottom">Donors</h2></span>
									
									
							<center><div class="col-12 text-center"><a class="button button--primary" href="donar.php" target="_blank">View all donars</a></div></center>
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-6 col-lg-3">
							<div class="footer-logo"><a class="footer-logo__link" href="#" target="_blank"><img class="footer-logo__img" src="assets/images/logo_white.png" alt="logo"/></a></div>
						...
						<div class="col-sm-6 col-lg-3">
							...
							<nav>
								<ul class="footer-menu">
									...
									<li class="footer-menu__item"><a class="footer-menu__link" href="team.php" target="_blank">Our Team</a></li>
									<li class="footer-menu__item"><a class="footer-menu__link" href="project.php" target="_blank">Projects</a></li>
