...
<script type="text/javascript">
                ...
                var name =
                    document.forms["RegForm"]["c_name"];
                var email =
                    document.forms["RegForm"]["c_email"];
                var phone =
                    document.forms["RegForm"]["c_cno"];

                var mess =
                    document.forms["RegForm"]["c_mess"];
...
if (isset($_POST["btn_sub"])) {
    ...
    $qry = "Insert into contact (c_name,c_email,c_mess,c_cno) values ('$c_name','$c_email','$c_mess','$c_cno') ";
    // echo $qry;
    $fire=$conn->query($qry);
...
?>
                                ...
                                <input id="text_fill" name="c_name" placeholder="Full Name" value="<?php echo $c_name;?>">
                                      </div>
                                ...
                                <input id="text_fill" type="Email" name="c_email" placeholder="Email ID" value="<?php echo $c_email;?>">
                                      </div>

                                      <div>
                                         <h4 id="form_h"><p >Messege:</p></h4>
                                <input id="text_fill" type="text"  name="c_mess" placeholder="Messege" value="<?php echo $c_mess;?>">
                                      </div>

                                      <div>
                                         <h4 id="form_h"><p >Contact Number:</p></h4>
                                <input id="text_fill" type="text" name="c_cno" placeholder="Contact Number" value="<?php echo $c_cno;?>">
                                      </div>
