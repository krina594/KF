...
<h2><center>Our Team Member</center></h2>
<div class="row"> 
<?php
$ev_id="";
...
while ($res_event=$qry_event->fetch_assoc()) 
    
    {
        ...
        $heading = $res_event["t_name"]; 
        $place = $res_event["t_cno"];
        $date = $res_event["t_email"];
?>
        ...
        <div class="gallery" >
        <a target="_blank">
            <img src="<?php echo $imageURL; ?>" alt="$alter_img" width="600" height="400"/>
          <div> <h5><center><?php echo $heading; ?></center></h5></div>
          <div> <center><?php echo $place; ?></center><br></div>
            <div><center><?php echo $date; ?></center></div>
