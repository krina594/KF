...
?>
                                    ...
                                    <h1 class="panel-title">AHMEDABAD BOOK CLUB</h1>
<?php
                                                ...
                                                <!--<span style="color: blue;font-size: 20px"><b><?php echo $res["e_heading"];?></b></span>-->
...
<h1 class="panel-title">PRAYAS</h1>
<?php
...
<div>
    ...
    <h1 class="panel-title">SAHARA</h1>
<?php
...
<div>
    ...
    <h1 class="panel-title">THE SCIENCE CLUB</h1>
<?php
...
<div>
    ...
    <h1 class="panel-title">SHISHU GRUH</h1>
<?php
...
<div>
    ...
    <h1 class="panel-title">SHURUAAT</h1>
<?php
